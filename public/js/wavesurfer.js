...
var WaveSurfer = {
    ...
    moveFunctionBar: function (progress) {
        this.drawer.drawFunctionBar(progress);
    },
...
WaveSurfer.Drawer = {
    ...
    drawFunctionBar: function (progress) {
        this.updateFunctionBar(progress * this.width);
    },
    ...
    updateFunctionBar: function (position) {}
};
...
WaveSurfer.util.extend(WaveSurfer.Drawer.MultiCanvas, {
    ...
    updateFunctionBar: function (pos) {
        console.log(pos);
        var entry = this.canvases[0];
        var ctx = entry.waveCtx;
        ctx.beginPath();
        ctx.moveTo(pos, 0);
